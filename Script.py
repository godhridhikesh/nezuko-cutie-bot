class script(object):
     START_TXT = """Hᴀɪ ᴛʜᴇʀᴇ {}.ɪᴀᴍ Pɪᴋᴀᴄʜᴜ ⚡️
   Iᴀᴍ ᴀ ᴡᴇʟʟ ᴍᴀɪɴᴛᴀɴᴇᴅ sᴇʀɪᴇs ʙᴏᴛ 🦋 ʏᴏᴜ ᴄᴀɴ ᴀsᴋ ᴍᴇ ᴛʜᴇ ᴍᴏᴠɪᴇs, sᴇʀɪᴇs ʏᴏᴜ ᴡᴀɴᴛ ..🍭"""
     HELP_TXT = """ʜᴇʏ  {}
 ᴡᴀɴɴᴀ ɴᴇᴇᴅ sᴏᴍᴇ ʜᴇʟᴘ 🧚‍♀."""
     ABOUT_TXT = """❦︎  ᴍʏ ɴᴀᴍᴇ : Nᴇᴢᴜᴋᴏ ᴋᴀᴍᴀᴅᴏ 🎀
 ❦︎ ᴄʀᴇᴀᴛᴏʀ : <a href=https://t.me/mr_perfect_07>Mʀ Pᴇʀғᴇᴄᴛ ❄️</a>
 ❦︎ ʟɪʙʀᴀʀʏ : 𝙿𝚈𝚁𝙾𝙶𝚁𝙰𝙼
 ❦︎ ʟᴀɴɢᴜᴀɢᴇ : 𝙿𝚈𝚃𝙷𝙾𝙽 𝟹
